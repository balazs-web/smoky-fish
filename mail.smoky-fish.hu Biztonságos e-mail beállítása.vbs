' mail.smoky-fish.hu Biztonságos e-mail beállítása.vbs
'
...
' *************************************************************************
strIncServerAddress	   = "mail.smoky-fish.hu"		 					' This is the address for the mail server
strOutServerAddress	   = "mail.smoky-fish.hu"		 					' This is the address for the mail server
...
strAccount			   = "info@smoky-fish.hu"							' Mail account to connect as
strSecureConnection    = "00000001"					' Use a secure connection - 00000001 for true, 00000000 for false
strCloseText 		   = "A folytatáshoz előtt zárja be a következőt: Windows Live Mail."
strFolderNotFoundText  = "Lehetséges hogy a Windows Live Mail nincs telepítve; a következő könyvtár nem található:"
strProgramNotFoundText = "Lehetséges hogy a Windows Live Mail nincs telepítve; a következő fájl nem található:"
strFileNotFoundText	   = "A fájl nem található."
